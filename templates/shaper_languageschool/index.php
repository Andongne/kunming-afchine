...
<script src="<?php echo $this->baseurl ?>/templates/shaper_languageschool/js/calendar-i18n.js?v=20260505q"></script>
  <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/shaper_languageschool/css/afk-styles.css?v=2026050807">
</head>
        ...
        <div class="body-innerwrapper">
            ...
            if ($_afkInjectCta && !empty($_afkCtaMods)):
                ...
                foreach ($_afkCtaMods as $_afkMod) {
                    $_afkCtaHtml .= '<div class="col-lg-4 col-md-4 col-sm-12 afk-cta-col"><div class="afk-cta-card h-100" style="padding:50px;text-align:center;background:#fff;"><div class="afk-sidebar-title">' . htmlspecialchars($_afkMod->title) . '</div>' . \Joomla\CMS\Helper\ModuleHelper::renderModule($_afkMod) . '</div></div>';
                }
