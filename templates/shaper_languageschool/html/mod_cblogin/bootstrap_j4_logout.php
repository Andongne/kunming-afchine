...
<form action="<?php echo $_CB_framework->viewUrl( 'logout', true, null, 'html', $secureForm ); ?>" method="post" id="login-form-<?php echo $module->id; ?>" class="mod-login-logout form-vertical cbLogoutForm">
	...
	<?php
		...
		$_afk_url   = \Joomla\CMS\Router\Route::_('index.php?option=com_comprofiler&view=userprofile&Itemid=1046');
	?>
	<div class="mod-login-logout__button mb-2">
		<a href="<?php echo $_afk_url; ?>" class="btn btn-outline-danger">
